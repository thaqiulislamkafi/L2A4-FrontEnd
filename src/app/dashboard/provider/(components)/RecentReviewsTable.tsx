...
export interface RecentProviderReview {
  id: string;
  meal_id: string;
  user_id: string;
  rating: number;
...
const columns: ColumnDef<RecentProviderReview>[] = [
  {
    accessorKey: "user_id",
    header: "Customer",
    cell: ({ row }) => (
  ...
  },
  {
    ...
    header: "Comment",
    cell: ({ row }) => (
      <p className="max-w-md truncate text-sm text-orange-800/80 dark:text-orange-200/80">
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <CardDescription className="mt-1 text-xs text-orange-700/60 dark:text-orange-300/60">
              What your customers are saying about your meals.
            </CardDescription>
          </div>
