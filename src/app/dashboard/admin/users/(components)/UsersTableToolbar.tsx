...
export default function UsersTableToolbar({ search, onSearchChange, onReset }: UsersTableToolbarProps) {
    ...
    <div className="flex flex-col gap-3 border-b border-orange-100 bg-orange-50/40 p-4 dark:border-orange-900/40 dark:bg-orange-950/10 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex w-full items-center gap-2 sm:w-auto">
        <div className="relative min-w-0 flex-1 sm:w-72">
          ...
          <Input value={search} onChange={(event) => onSearchChange(event.target.value)} placeholder="Search users..." className="h-9 w-full rounded-lg border-orange-200 bg-white pl-9 pr-9 text-sm text-orange-900 placeholder:text-orange-400/60 focus-visible:border-orange-500 focus-visible:ring-orange-500/20 dark:border-orange-800 dark:bg-orange-950/20 dark:text-orange-100 dark:placeholder:text-orange-400/50" />
