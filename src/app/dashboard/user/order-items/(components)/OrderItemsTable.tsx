...
import { OrderItemsTableColumns } from "@/app/dashboard/admin/order-items/(components)/OrderItemsTableColumns";
...
export default function OrderItemsTable({ orderItems, isFetching = false }: OrderItemsTableProps) {
  ...
  const columns = React.useMemo(
    () => OrderItemsTableColumns((orderId) => router.push(`/dashboard/user/orders/${orderId}`)),
    [router]
  );
