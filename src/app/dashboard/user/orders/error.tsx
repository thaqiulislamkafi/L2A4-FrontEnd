...
interface UserOrdersErrorProps {
  message?: string;
  onRetry?: () => void;
}

export default function UserOrdersError({
  message = "Something went wrong while loading your orders. Please try again.",
  onRetry,
}: UserOrdersErrorProps) {
  return (
      ...
      <CardContent className="flex flex-col items-center justify-center px-6 py-12 text-center">
        ...
        {onRetry && (
          <Button
            ...
            variant="outline"
            onClick={onRetry}
            className="mt-5 rounded-lg border-orange-200 text-orange-700 hover:bg-orange-50 hover:text-orange-700 dark:border-orange-800 dark:text-orange-300 dark:hover:bg-orange-950/40"
          >
