  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      <div className="space-y-2">
        ...
        <Skeleton className="h-4 w-72 rounded-md bg-orange-100 dark:bg-orange-950/50" />
      </div>
            ...
            <CardHeader className="flex flex-row items-center justify-between gap-4 border-b border-orange-100/80 px-5 py-4 dark:border-orange-900/30">
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0 space-y-2">
                  <Skeleton className="h-4 w-24 rounded-md bg-orange-100 dark:bg-orange-950/50" />
                  <Skeleton className="h-3 w-28 rounded-md bg-orange-100 dark:bg-orange-950/50" />
                </div>
              </div>
              <div className="flex gap-2">
                <Skeleton className="h-8 w-16 rounded-lg bg-orange-100 dark:bg-orange-950/50" />
                <Skeleton className="h-8 w-16 rounded-lg bg-orange-100 dark:bg-orange-950/50" />
              </div>
            </CardHeader>
