  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          `${geist.className} flex h-full w-[var(--sidebar-width)] flex-col bg-sidebar text-sidebar-foreground`,
          className
        )}
        {...props}
      >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          `${geist.className} relative w-[var(--sidebar-width)] bg-transparent transition-[width] duration-200 ease-linear`,
